...
RUN_NAME=01-1224-dlm_training_ur50_unconditional_1B
...
echo "cache dir: $data_local_cache_dir"
...
# before running training, print all args
echo "GPT_MODEL_ARGS: " ${GPT_MODEL_ARGS[@]}
